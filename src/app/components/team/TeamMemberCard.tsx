...
/**
 * TeamMemberCard - Carte de présentation d'un membre de l'équipe
 */
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        <div className="relative w-28 h-28 mb-4 rounded-full overflow-hidden ring-2 ring-white/10 group-hover:ring-cyan-500/30 transition-all duration-300">
          <Image
            src={image}
            alt={name}
            fill
...
function SocialLinks({ social }: SocialLinksProps) {
  const hasLinks = social.linkedin || social.github || social.twitter;

  if (!hasLinks) return null;

  return (
    <div className="flex gap-3 pt-4 border-t border-white/10 w-full justify-center">
      {social.linkedin && (
        <a
